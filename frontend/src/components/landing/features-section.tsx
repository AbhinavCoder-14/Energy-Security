...
const features = [
  {
    ...
    description:
      "Trigger a geopolitical scenario and watch the fallout propagate in seconds. From a Strait of Hormuz blockade to Red Sea conflict, model the shock before it happens.",
    visual: "deploy",
  },
  {
    number: "02",
    ...
    description:
      "A three-stage agent pipeline ingests global signals, quantifies the economic shock, and drafts prioritized procurement directives, no hallucinated numbers.",
    visual: "ai",
  },
  {
    number: "03",
    title: "Chokepoint Risk Matrix",
    description:
      "Live threat scoring for the world's critical shipping routes. Watch risk meters slide as tankers reroute and maritime tension escalates.",
    visual: "collab",
  },
  {
    number: "04",
    ...
    description:
      "Air-gapped deployment, end-to-end encryption, and granular clearance controls. Intelligence built for governments and C-suite command.",
    visual: "security",
  },
];
...
function SecurityVisual() {
  return (
    <svg viewBox="0 0 200 160" className="w-full h-full">
      ...
      <circle cx="100" cy="80" r="4" fill="var(--color-background, #fff)" />
      <rect x="98" y="82" width="4" height="8" fill="var(--color-background, #fff)" />
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        <Reveal className="mb-16 lg:mb-24">
          ...
          <h2 className="text-4xl lg:text-6xl font-display tracking-wide">
            ...
            <br />
            <span className="text-muted-foreground">Not noise you have to parse.</span>
          </h2>
        </Reveal>
